...
INPUT_PATH = r"C:\Users\adamg\Desktop\ai_healthcare\small"
OUTPUT_PATH = r"C:\Users\adamg\Desktop\ai_healthcare\resized_small"

def pad_to_square_one_sided(image):
    ...
    if width > height:
        new_image.paste(image, (0, 0))  # pad bottom
    else:
        new_image.paste(image, (0, 0))  # pad right
    return new_image
    ...
    try:
        with Image.open(file_path) as img:
            ...
            if width >= TARGET_SIZE[0] and height >= TARGET_SIZE[1]:
                square_img = pad_to_square_one_sided(img)
...
def normalize_images_multithreaded(input_dir, output_dir):
    ...
    image_files = [f for f in all_files if f.suffix.lower() in [".jpg", ".jpeg", ".png", ".bmp", ".gif", ".webp"]]
